...
public:
    ...
    // AUV2000 Custom Properties
    Q_PROPERTY(float rudderPosition    READ    rudderPosition    NOTIFY rudderPositionChanged)
    Q_PROPERTY(float rudderSpeed    READ    rudderSpeed    NOTIFY rudderSpeedChanged)
    Q_PROPERTY(float rudderLoad    READ    rudderLoad    NOTIFY rudderLoadChanged)
    Q_PROPERTY(float rudderVoltage    READ    rudderVoltage    NOTIFY rudderVoltageChanged)
    Q_PROPERTY(float rudderTemperature    READ    rudderTemperature    NOTIFY rudderTemperatureChanged)
    Q_PROPERTY(float thrusterDuty    READ    thrusterDuty    NOTIFY thrusterDutyChanged)
    Q_PROPERTY(float thrusterTempOnChip    READ    thrusterTempOnChip    NOTIFY thrusterTempOnChipChanged)
    Q_PROPERTY(float thrusterTempAmbient    READ    thrusterTempAmbient    NOTIFY thrusterTempAmbientChanged)
    Q_PROPERTY(float thrusterCurrent    READ    thrusterCurrent    NOTIFY thrusterCurrentChanged)
    Q_PROPERTY(float thrusterRSpeed    READ    thrusterRSpeed    NOTIFY thrusterRSpeedChanged)
    Q_PROPERTY(float thrusterDSpeed    READ    thrusterDSpeed    NOTIFY thrusterDSpeedChanged)
    Q_PROPERTY(uint pistonLSHead    READ    pistonLSHead    NOTIFY pistonLSHeadChanged)
    Q_PROPERTY(uint pistonLSTail    READ    pistonLSTail    NOTIFY pistonLSTailChanged)
    Q_PROPERTY(float pistonPosition    READ    pistonPosition    NOTIFY pistonPositionChanged)
    Q_PROPERTY(float pistonDuty    READ    pistonDuty    NOTIFY pistonDutyChanged)
    Q_PROPERTY(float pistonTempOnChip    READ    pistonTempOnChip    NOTIFY pistonTempOnChipChanged)
    Q_PROPERTY(float pistonTempAmbient    READ    pistonTempAmbient    NOTIFY pistonTempAmbientChanged)
    Q_PROPERTY(float pistonCurrent    READ    pistonCurrent    NOTIFY pistonCurrentChanged)
    Q_PROPERTY(float pistonRSpeed    READ    pistonRSpeed    NOTIFY pistonRSpeedChanged)
    Q_PROPERTY(float pistonDSpeed    READ    pistonDSpeed    NOTIFY pistonDSpeedChanged)
    Q_PROPERTY(uint mass_shifterLSHead    READ    mass_shifterLSHead    NOTIFY mass_shifterLSHeadChanged)
    Q_PROPERTY(uint mass_shifterLSTail    READ    mass_shifterLSTail    NOTIFY mass_shifterLSTailChanged)
    Q_PROPERTY(float mass_shifterPosition    READ    mass_shifterPosition    NOTIFY mass_shifterPositionChanged)
    Q_PROPERTY(float mass_shifterDuty    READ    mass_shifterDuty    NOTIFY mass_shifterDutyChanged)
    Q_PROPERTY(float mass_shifterTempOnChip    READ    mass_shifterTempOnChip    NOTIFY mass_shifterTempOnChipChanged)
    Q_PROPERTY(float mass_shifterTempAmbient    READ    mass_shifterTempAmbient    NOTIFY mass_shifterTempAmbientChanged)
    Q_PROPERTY(float mass_shifterCurrent    READ    mass_shifterCurrent    NOTIFY mass_shifterCurrentChanged)
    Q_PROPERTY(float mass_shifterRSpeed    READ    mass_shifterRSpeed    NOTIFY mass_shifterRSpeedChanged)
    Q_PROPERTY(float mass_shifterDSpeed    READ    mass_shifterDSpeed    NOTIFY mass_shifterDSpeedChanged)
    ...
    // AUV2000 Custom Accessors
    float rudderPosition (void) { return _rudderPosition;}
    float rudderSpeed (void) { return _rudderSpeed;}
    float rudderLoad (void) { return _rudderLoad;}
    float rudderVoltage (void) { return _rudderVoltage;}
    float rudderTemperature (void) { return _rudderTemperature;}
    float thrusterDuty (void) { return _thrusterDuty;}
    float thrusterTempOnChip (void) { return _thrusterTempOnChip;}
    float thrusterTempAmbient (void) { return _thrusterTempAmbient;}
    float thrusterCurrent (void) { return _thrusterCurrent;}
    float thrusterRSpeed (void) { return _thrusterRSpeed;}
    float thrusterDSpeed (void) { return _thrusterDSpeed;}
    uint pistonLSHead (void) {return _pistonLSHead;}
    uint pistonLSTail (void) {return _pistonLSTail;}
    float pistonPosition (void) { return _pistonPosition;}
    float pistonDuty (void) { return _pistonDuty;}
    float pistonTempOnChip (void) { return _pistonTempOnChip;}
    float pistonTempAmbient (void) { return _pistonTempAmbient;}
    float pistonCurrent (void) { return _pistonCurrent;}
    float pistonRSpeed (void) { return _pistonRSpeed;}
    float pistonDSpeed (void) { return _pistonDSpeed;}
    uint mass_shifterLSHead (void) {return _mass_shifterLSHead;}
    uint mass_shifterLSTail (void) {return _mass_shifterLSTail;}
    float mass_shifterPosition (void) { return _mass_shifterPosition;}
    float mass_shifterDuty (void) { return _mass_shifterDuty;}
    float mass_shifterTempOnChip (void) { return _mass_shifterTempOnChip;}
    float mass_shifterTempAmbient (void) { return _mass_shifterTempAmbient;}
    float mass_shifterCurrent (void) { return _mass_shifterCurrent;}
    float mass_shifterRSpeed (void) { return _mass_shifterRSpeed;}
    float mass_shifterDSpeed (void) { return _mass_shifterDSpeed;}
...
signals:
    ...
    // AUV2000 Custom Signals
    void rudderPositionChanged(float _value);
    void rudderSpeedChanged(float _value);
    void rudderLoadChanged(float _value);
    void rudderVoltageChanged(float _value);
    void rudderTemperatureChanged(float _value);
    void thrusterDutyChanged (float _value);
    void thrusterTempOnChipChanged (float _value);
    void thrusterTempAmbientChanged (float _value);
    void thrusterCurrentChanged (float _value);
    void thrusterRSpeedChanged (float _value);
    void thrusterDSpeedChanged (float _value);
    void pistonLSHeadChanged (uint _value);
    void pistonLSTailChanged (uint _value);
    void pistonPositionChanged (float _value);
    void pistonDutyChanged (float _value);
    void pistonTempOnChipChanged (float _value);
    void pistonTempAmbientChanged (float _value);
    void pistonCurrentChanged (float _value);
    void pistonRSpeedChanged (float _value);
    void pistonDSpeedChanged (float _value);
    void mass_shifterLSHeadChanged (uint8_t _value);
    void mass_shifterLSTailChanged (uint8_t _value);
    void mass_shifterPositionChanged (float _value);
    void mass_shifterDutyChanged (float _value);
    void mass_shifterTempOnChipChanged (float _value);
    void mass_shifterTempAmbientChanged (float _value);
    void mass_shifterCurrentChanged (float _value);
    void mass_shifterRSpeedChanged (float _value);
    void mass_shifterDSpeedChanged (float _value);
...
private:
    ...
    // AUV2000 Custom Handlers
    void _handleMassShifter(mavlink_message_t& message);
    void _handlePiston(mavlink_message_t& message);
    void _handleThruster(mavlink_message_t& message);
    void _handleBoardARM1(mavlink_message_t& message);
    void _handleBoardARM2(mavlink_message_t& message);
    ...
    // AUV2000 Custom Private Members
    float _rudderPosition = 0.0f;
    float _rudderSpeed = 0.0f;
    float _rudderLoad = 0.0f;
    float _rudderVoltage = 0.0f;
    float _rudderTemperature = 0.0f;
    float _thrusterDuty = 0.0f;
    float _thrusterTempOnChip = 0.0f;
    float _thrusterTempAmbient = 0.0f;
    float _thrusterCurrent = 0.0f;
    float _thrusterRSpeed = 0.0f;
    float _thrusterDSpeed = 0.0f;
    uint _pistonLSHead = 0;
    uint _pistonLSTail = 0;
    float _pistonPosition = 0.0f;
    float _pistonDuty = 0.0f;
    float _pistonTempOnChip = 0.0f;
    float _pistonTempAmbient = 0.0f;
    float _pistonCurrent = 0.0f;
    float _pistonRSpeed = 0.0f;
    float _pistonDSpeed = 0.0f;
    uint _mass_shifterLSHead = 0;
    uint _mass_shifterLSTail = 0;
    float _mass_shifterPosition = 0.0f;
    float _mass_shifterDuty = 0.0f;
    float _mass_shifterTempOnChip = 0.0f;
    float _mass_shifterTempAmbient = 0.0f;
    float _mass_shifterCurrent = 0.0f;
    float _mass_shifterRSpeed = 0.0f;
    float _mass_shifterDSpeed = 0.0f;
