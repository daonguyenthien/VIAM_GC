// MESSAGE VIAM_MASS_SHIFTER_STATUS support class
...
/**
 * @brief VIAM_MASS_SHIFTER_STATUS message
 *
 * Mass shifter status message.
 */
struct VIAM_MASS_SHIFTER_STATUS : mavlink::Message {
    static constexpr msgid_t MSG_ID = 13005;
    static constexpr size_t LENGTH = 32;
    static constexpr size_t MIN_LENGTH = 32;
    static constexpr uint8_t CRC_EXTRA = 115;
    static constexpr auto NAME = "VIAM_MASS_SHIFTER_STATUS";
